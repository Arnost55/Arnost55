...
export const projects: Project[] = [
  {
    ...
    description: 'A modern, accessible portfolio built with React, TypeScript, and Tailwind CSS featuring Arc Browser-inspired design system with frosted glass effects and warm gradients.',
    ...
    technologies: ['React 18', 'TypeScript', 'Tailwind CSS v4', 'Framer Motion', 'React Router', 'Vite']
  },
  {
    id: 'task-manager',
    ...
    longDescription: 'Task Manager Pro is a full-stack application featuring real-time collaboration using WebSockets, Kanban-style boards with drag-and-drop functionality, and granular permission controls for team workspaces. Built with a modern tech-built with performance and UX as top priorities.',
    ...
    technologies: ['React', 'TypeScript', 'Node.js', 'Express', 'Socket.io', 'PostgreSQL', 'Prisma', 'Tailwind CSS']
  },
  {
    id: 'learning-platform',
    title: 'EduLearn Platform',
    description: 'An interactive learning platform for educators with course creation, progress tracking, and assessment tools.',
    longDescription: 'EduLearn is designed for educators to create and manage interactive courses with multimedia content, quizzes, and student progress analytics. Features include a rich text editor for lesson creation, automated grading, and detailed reporting dashboards.',
    ...
    technologies: ['Next.js 14', 'React', 'TypeScript', 'MongoDB', 'Prisma', 'NextAuth', 'TipTap', 'Yjs', 'Tailwind CSS']
  },
  {
  ...
  },
  {
    ...
    description: 'A distraction-free markdown editor with live preview, syntax highlighting, and export options.',
  ...
  },
  {
    ...
    description: 'Personal finance tracker with categorization, budgets, recurring transactions, and data visualization.',
...
export const education: Education[] = [
  {
    ...
    startDate: '2020',
    endDate: '2024',
    description: 'Focused on software engineering, human-computer interaction, and educational technology.',
    highlights: [
  ...
  },
  {
    ...
    startDate: '2022',
    endDate: '2023',
    description: 'Intensive program covering user research, interaction design, design systems, and prototyping.',
    highlights: [
